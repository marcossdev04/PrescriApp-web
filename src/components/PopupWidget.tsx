      ...
      <Disclosure>
        {({ open }) => (
          <>
            ...
            <Transition
              className="sm:top-auto  sm:right-5 sm:left-auto fixed bottom-[100px]  left-0 right-0 top-0 z-50"
              enter="transition duration-200 transform ease"
              ...
              as="div"
            >
              <DisclosurePanel className=" sm:w-[350px] sm:h-[600px]  sm:max-h-[calc(100vh-120px)] left-0 flex h-full min-h-[250px] w-full flex-col overflow-hidden rounded-md border border-gray-300 bg-white shadow-2xl dark:border-gray-800">
                ...
                <div className="h-full flex-grow overflow-auto bg-gray-50 p-6 ">
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <div className="flex h-full flex-col items-center justify-center rounded-md text-center text-white">
                      ...
                      <p className="md:px-3 text-gray-700">{Message}</p>
                      <button
