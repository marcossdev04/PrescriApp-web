      ...
      {({ open }) => (
        <div className="lg:w-auto flex w-full flex-wrap items-center justify-between">
          ...
          <DisclosureButton
            ...
            className="lg:hidden ml-auto rounded-md px-2 py-1 text-gray-500 hover:text-indigo-500 focus:bg-indigo-100 focus:text-indigo-500 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
          >
            <svg
          ...
          <DisclosurePanel className="lg:hidden my-5 flex w-full flex-wrap">
            <>
              ...
              <Link
                ...
                className="lg:ml-5 mt-3 w-full rounded-md bg-indigo-600 px-6 py-2 text-center text-white"
              >
                {cta.text}
              </Link>
            </>
