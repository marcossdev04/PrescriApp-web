  ...
  return (
    <>
      <Container className="flex">
        <div className="lg:w-1/2 flex w-full items-center mobile:mt-5 mobile:w-full">
          <div className="mb-8 max-w-2xl mobile:max-w-[100%]">
            <h1 className="lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight text-4xl font-bold leading-snug tracking-tight text-gray-800 dark:text-white mobile:text-3xl">
